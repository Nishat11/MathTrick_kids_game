...
{
    public partial class No_multi_by_12 : Form
    {
        Constants con = new Constants();
        public No_multi_by_12()
        {
            InitializeComponent();
        }
        ...
        public void Initialize_all_value_for_trick()
        {
            ...
            con.name_of_textbox.Add(No_12Trick_ans_1);
            con.name_of_textbox.Add(No_12Trick_ans_2);
            con.name_of_textbox.Add(No_12Trick_ans_3);
            con.name_of_textbox.Add(No_12Trick_ans_4);
        ...
        public void Check_Num_of_answers()
        {
            ...
            else if (con.correct_answers == 3 && con.question_attend == 4)
            {
                ...
                con.home.Update_xml(6, con.No_star);
        ...
        private void No_multi_by_12_Load(object sender, EventArgs e)
        {
            con.reset_all();
            Initialize_all_value_for_trick();
        }

        private void No_multi_by_12_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private void No_12Trick_ans_1_KeyPress(object sender, KeyPressEventArgs e)
        {
