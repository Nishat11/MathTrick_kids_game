...
{
    public partial class MultiplyBy5ToThePowerN : Form
    {
        Constants con = new Constants();
        public MultiplyBy5ToThePowerN()
        {
            InitializeComponent();
        }
        ...
        private void MultiplyBy5ToThePowerN_Load(object sender, EventArgs e)
        {
            InVisibleControls();
            txtAnswer1.Focus();
        }
        ...
        {
            MessageBox.Show("The correct answer is 175", "Correct Answer", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
        ...
        {
            MessageBox.Show("The correct answer is 50", "Correct Answer", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }

        private void assistance4_MouseClick(object sender, MouseEventArgs e)
        {
            MessageBox.Show("The correct answer is 1125", "Correct Answer", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
        ...
        void CheckAnswers()
        {
            ...
            if (count == 3)
            {
                con.home.Update_xml(20, countstars);
            }
            else if (count == 4)
            {
                countstars++;
