...
{
    public partial class multiplyBy6 : Form
    {
        ...
        private void multiplyBy6_Load(object sender, EventArgs e)
        {
        ...
        } // end of Initialize_all_value_for_trick function
        ...
        public void Check_Num_of_answers()
        {
            ...
            else if (correct_answers == 3 && question_attend == 4)
            {
                ...
                con.home.Update_xml(18,No_star);
            }
