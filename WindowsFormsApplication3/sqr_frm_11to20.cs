...
{
    public partial class sqr_frm_11to20 : Form
    {
        Constants con = new Constants();
        public sqr_frm_11to20()
        {
            InitializeComponent();
        }
        public void Initialize_all_value_for_trick()
        {
            ...
            con.name_of_textbox.Add(sqr_11to20Trick_ans_1);
            con.name_of_textbox.Add(sqr_11to20Trick_ans_2);
            con.name_of_textbox.Add(sqr_11to20Trick_ans_3);
            con.name_of_textbox.Add(sqr_11to20Trick_ans_4);
            con.question_attend = 0;

            //Add name for sad face buttons
            con.sad_face.Add(Trick_1btnNo_1); con.sad_face.Add(Trick_1btnNo_2);
            con.sad_face.Add(Trick_1btnNo_3); con.sad_face.Add(Trick_1btnNo_4);

            //Add name for smile face buttons
            con.smile_face.Add(Trick1btnYes_1); con.smile_face.Add(Trick1btnYes_2);
            con.smile_face.Add(Trick1btnYes_3); con.smile_face.Add(Trick1btnYes_4);

            //Add name for correct answer buttons
            con.correct_answer.Add(Trick1_correct_1); con.correct_answer.Add(Trick1_correct_2);
            con.correct_answer.Add(Trick1_correct_3); con.correct_answer.Add(Trick1_correct_4);
        }
        //Check all answer given and minimum 3 are correct..
        public void Check_Num_of_answers()
        {
            if (con.correct_answers < 3 && con.question_attend == 4)
            {
            ...
            else if (con.correct_answers == 3)
            {
                ...
                con.home.Update_xml(5, con.No_star);
            }
        ...
        private void sqr_frm_11to20_FormClosing(object sender, FormClosingEventArgs e)
        {
            //On close of trick page display home page back
            con.home.Show();
        }

        private void sqr_frm_11to20_Load(object sender, EventArgs e)
        {
            con.reset_all();
            Initialize_all_value_for_trick();
        }

        private void sqr_11to20Trick_ans_1_KeyPress(object sender, KeyPressEventArgs e)
        {
