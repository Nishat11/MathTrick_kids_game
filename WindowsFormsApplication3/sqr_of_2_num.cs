...
{
    public partial class sqr_of_2_num : Form
    {
        ...
        public void Initialize_all_value_for_trick()
        {
            ...
            con.name_of_textbox.Add(sqr_of_2numTrick_ans_1);
            con.name_of_textbox.Add(sqr_of_2numTrick_ans_2);
            con.name_of_textbox.Add(sqr_of_2numTrick_ans_3);
            con.name_of_textbox.Add(sqr_of_2numTrick_ans_4);
        ...
        public void Check_Num_of_answers()
        {
            ...
            else if (con.correct_answers == 3 && con.question_attend == 4)
            {
                ...
                con.home.Update_xml(7, con.No_star);
            }
        ...
        private void sqr_of_2_num_Load(object sender, EventArgs e)
        {
            con.reset_all();
            Initialize_all_value_for_trick();          
        }

        private void sqr_of_2_num_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private void sqr_of_2numTrick_ans_1_KeyPress(object sender, KeyPressEventArgs e)
        {
