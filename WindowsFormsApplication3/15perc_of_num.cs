...
{
    public partial class _15perc_of_num : Form
    {
        Constants con = new Constants();
        public _15perc_of_num()
        {
            InitializeComponent();
        }
        public void Initialize_all_value_for_trick()
        {
            //Add correct answers....// try to only check first digit after "."
            con.answers.Add("1.8");
            con.answers.Add("2.2");
            con.answers.Add("1.6");
            con.answers.Add("2.1");
            ...
            con.name_of_textbox.Add(per_15Trick_ans_1);
            con.name_of_textbox.Add(per_15Trick_ans_2);
            con.name_of_textbox.Add(per_15Trick_ans_3);
            con.name_of_textbox.Add(per_15Trick_ans_4);
        ...
        public void Check_Num_of_answers()
        {
            ...
            else if (con.correct_answers == 3 && con.question_attend == 4)
            {
                ...
                con.home.Update_xml(9, con.No_star);
            }
        ...
        private void _15perc_of_num_Load(object sender, EventArgs e)
        {
            con.reset_all();
            Initialize_all_value_for_trick();
        }

        private void _15perc_of_num_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private void per_15Trick_ans_1_KeyPress(object sender, KeyPressEventArgs e)
        {

        }

        private void per_15Trick_ans_1_KeyPress_1(object sender, KeyPressEventArgs e)
        {
